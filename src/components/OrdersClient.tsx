...
export default function OrdersClient() {
  ...
  const getStatusStep = (status: string) => {
    ...
    if (s === "OUT_FOR_DELIVERY" || s === "OUT") return 3;
    if (s === "DELIVERED") return 4;
    return 0;
  };

  const STATUS_STEPS = [
    { label: "Ordered", desc: "Received", icon: Clipboard },
    { label: "Packed", desc: "Batch Packed", icon: Package },
    { label: "Shipped", desc: "In Transit", icon: Truck },
    { label: "Out for Delivery", desc: "Local Courier", icon: Truck },
